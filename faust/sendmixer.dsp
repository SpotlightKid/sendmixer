...
// Controls
send_a_lvl = vslider("[1] Send A [style:knob] [unit:dB] [symbol:send_a_lvl]", -60.0, -60.0, 0.0, 0.01) : si.smoo;
send_a_pos = checkbox("[2] Send A Post [symbol:send_a_post]");
send_b_lvl = vslider("[3] Send B [style:knob] [unit:dB] [symbol:send_b_lvl]", -60.0, -60.0, 0.0, 0.01) : si.smoo;
send_b_pos = checkbox("[4] Send B Post [symbol:send_b_post]");
main_lvl = vslider("[5] Main Level [style:slider] [unit:dB] [symbol:main_lvl]", 0.0, -90.0, 20.0, 0.01) : si.smoo;
