...
lv2lint:
	$(MAKE) lv2lint -C plugins/sendmixer

# --------------------------------------------------------------

clean:
	$(MAKE) clean -C dpf/utils/lv2-ttl-generator
	$(MAKE) clean -C plugins/sendmixer
	rm -rf bin build

install: all
	$(MAKE) install -C plugins/sendmixer

install-user: all
	$(MAKE) install-user -C plugins/sendmixer
